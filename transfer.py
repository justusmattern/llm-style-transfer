...
def run(in_file, out_file, prompt_in, prompt_out, model_name, learning_rate):
...
if __name__ == '__main__':
    ...
    run(in_file = args.in_file, out_file = args.out_file, prompt_in = args.prompt_in, prompt_out = args.prompt_out, model_name=args.model, learning_rate = args.learning_rate)
